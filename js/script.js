...
const victoryState = {
  pos1: function(choice) {
    ...
    function positionCheck() {
      if(position[1] == choice && position[2] == choice || position[4] == choice && position[8] == choice || position[3] == choice && position[6] == choice){
  ...
  pos2: function(choice) {
    ...
    function positionCheck() {
      if(position[0] == choice && position[2] == choice || position[4] == choice && position[7] == choice){
        victoryMessage(choice);
        return;
      }
    }
  ...
  pos3: function(choice) {
    ...
    function positionCheck() {
      if(position[0] == choice && position[1] == choice || position[4] == choice && position[6] == choice || position[5] == choice && position[8] == choice){
        victoryMessage(choice);
        return;
      }
    }
  ...
  pos4: function(choice) {
    ...
    function positionCheck() {
      if(position[0] == choice && position[6] == choice || position[4] == choice && position[5] == choice){
        victoryMessage(choice);
        return;
      }
    }
  ...
  pos5: function(choice) {
    ...
    function positionCheck() {
      if(position[0] == choice && position[8] == choice || position[2] == choice && position[6] == choice || position[3] == choice && position[5] == choice || position[1] == choice && position[7] == choice){
        victoryMessage(choice);
        return;
      }
    }
  ...
  pos6: function(choice) {
    ...
    function positionCheck() {
      if(position[2] == choice && position[8] == choice || position[3] == choice && position[4] == choice){
        victoryMessage(choice);
        return;
      }
    }
  ...
  pos7: function(choice) {
    ...
    function positionCheck() {
      if(position[0] == choice && position[3] == choice || position[4] == choice && position[2] == choice || position[7] == choice && position[8] == choice){
        victoryMessage(choice);
        return;
      }
    }
  ...
  pos8: function(choice) {
    ...
    function positionCheck() {
      if(position[1] == choice && position[4] == choice || position[6] == choice && position[8] == choice){
        victoryMessage(choice);
        return;
      }
    }
  ...
  pos9: function(choice) {
    ...
    function positionCheck() {
      if(position[2] == choice && position[5] == choice || position[0] == choice && position[4] == choice || position[6] == choice && position[7] == choice){
        victoryMessage(choice);
        return;
      }
    }
...
function victoryMessage(choice) {
  ...
  delay(function(){
    ...
    $("<div id='restart'> <img id='playerVictory' alt='testImage' src='img/" + choice +".png'> </img> <h3 id='victoryTitle'> has won!</h3> <span id='victory-btn'><a onclick='restart()'></a></span> </div>").appendTo("#victory");
  }, 150 ); 
...
function restart() {
  playSound("sounds/selection.wav", 0.80)
